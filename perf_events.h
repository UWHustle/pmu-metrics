...
* We collect the UMASK:EVENT_NUM values from the Intel
* Developer's Manual Vol. 3B.
***********************************************************/
...
* Note that first three events are supported by fixed counters
* in PMU version 2 or higher. Given the limited number of
* PERFEVTSEL MSRs, they should be used for other events in
* case fixed counters are available. 
***********************************************************/
